import { type AgentInquiry, mockAgentInquiries } from "@/data/inquiry-data";
import type React from "react";
import { useState } from "react";
import { AgentInquiryPagination } from "./AgentInquiryPagination";
import { AgentInquirySearchForm } from "./AgentInquirySearchForm";
import { AgentInquiryTable } from "./AgentInquiryTable";

const AgentInquiryManagement: React.FC = () => {
  ...
  // ダミーデータ（最終的に削除予定）
  const inquiries = mockAgentInquiries;
