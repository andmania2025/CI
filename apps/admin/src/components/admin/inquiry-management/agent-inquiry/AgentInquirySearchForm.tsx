...
interface AgentInquirySearchFormProps {
  formData: {
    freeword: string;
    companyName: string;
...
export const AgentInquirySearchForm: React.FC<AgentInquirySearchFormProps> = ({
  formData,
  isDetailSearchOpen,
  onInputChange,
  ...
  return (
    <div className="flex justify-between items-baseline mb-1">
      <h3 className="text-lg font-medium leading-none">業者問い合わせ</h3>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        <SelectItem value="propertyInfo">物件情報提供</SelectItem>
                        <SelectItem value="assessment">査定依頼</SelectItem>
                        <SelectItem value="cooperation">業務提携</SelectItem>
                        <SelectItem value="inquiry">その他問い合わせ</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                </div>
