import { type SiteInquiry, mockSiteInquiries } from "@/data/inquiry-data";
import type React from "react";
import { useState } from "react";
import { SiteInquiryPagination } from "./SiteInquiryPagination";
import { SiteInquirySearchForm } from "./SiteInquirySearchForm";
import { SiteInquiryTable } from "./SiteInquiryTable";

const SiteInquiryManagement: React.FC = () => {
  ...
  // ダミーデータ（最終的に削除予定）
  const inquiries: SiteInquiry[] = mockSiteInquiries;
