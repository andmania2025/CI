...
interface SiteInquirySearchFormProps {
  formData: {
    freeword: string;
    inquirerName: string;
    gender: {
...
export const SiteInquirySearchForm: React.FC<SiteInquirySearchFormProps> = ({
  formData,
  isDetailSearchOpen,
  onInputChange,
  ...
  return (
    <div className="flex justify-between items-baseline mb-1">
      <h3 className="text-lg font-medium leading-none">サイト問い合わせ</h3>
