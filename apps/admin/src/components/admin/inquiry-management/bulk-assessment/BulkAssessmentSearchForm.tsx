...
interface BulkAssessmentSearchFormProps {
  formData: {
    freeword: string;
...
export const BulkAssessmentSearchForm: React.FC<BulkAssessmentSearchFormProps> = ({
  formData,
  isDetailSearchOpen,
  onInputChange,
  ...
  return (
    <div className="flex justify-between items-baseline mb-1">
      <h3 className="text-lg font-medium leading-none">一括査定</h3>
