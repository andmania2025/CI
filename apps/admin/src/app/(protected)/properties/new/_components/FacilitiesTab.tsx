      ...
      <Card className="flex-1 flex flex-col overflow-hidden">
        <CardContent className="flex-1 overflow-y-auto space-y-2 p-6">
          ...
          <div className="space-y-1">
            <Label className="text-sm font-medium mb-2 block">設備</Label>
          ...
          <div className="grid grid-cols-3 gap-4 mt-6">
            {/* 駐車場有無 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">駐車場有無</Label>
              <Controller
            ...
            {/* 駐車料金（円） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">駐車料金（円）</Label>
              <Input placeholder="駐車料金を入力" type="number" {...register("parkingFee")} />
            </div>

            {/* 駐車場詳細記述 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">駐車場詳細記述</Label>
              <Textarea
            ...
            {/* 修繕積立金（円） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">修繕積立金（円）</Label>
              <Input placeholder="修繕積立金" type="number" {...register("repairReserve")} />
            </div>

            {/* 管理形態 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">管理形態</Label>
          ...
          <div className="grid grid-cols-4 gap-4 mt-4">
            {/* リフォーム */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">リフォーム</Label>
              <Textarea
            ...
            {/* 想定年間収入（万円） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">想定年間収入（万円）</Label>
              <Input placeholder="年間収入" type="number" {...register("expectedAnnualIncome")} />
            </div>

            {/* 表面利回り（％） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">表面利回り（％）</Label>
