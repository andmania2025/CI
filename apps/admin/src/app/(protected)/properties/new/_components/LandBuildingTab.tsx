      ...
      <Card className="flex-1 flex flex-col overflow-hidden">
        <CardContent className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-5 gap-4">
            ...
            {/* セットバック */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">セットバック</Label>
              <Input placeholder="セットバック" {...register("setback")} />
            </div>

            {/* 私道負担面積（㎡） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">私道負担面積（㎡）</Label>
            ...
            {/* 現況 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">現況</Label>
              <Textarea
                placeholder="現況を入力"
            ...
            {/* 建ぺい率（％） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">建ぺい率（％）</Label>
              <Input placeholder="建ぺい率" type="number" {...register("buildingCoverageRatio")} />
            </div>

            {/* 容積率（％） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">容積率（％）</Label>
              <Input placeholder="容積率" type="number" {...register("floorAreaRatio")} />
            </div>

            {/* 総戸数・総区画数 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">総戸数・総区画数</Label>
              <Input
          ...
          <div className="grid grid-cols-5 gap-4 mt-4">
            {/* 開発許可番号 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">開発許可番号</Label>
              <Input placeholder="開発許可番号" {...register("developmentPermitNumber")} />
            </div>

            {/* 開発面積（㎡） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">開発面積（㎡）</Label>
              <Input placeholder="開発面積" type="number" {...register("developmentArea")} />
            </div>

            {/* 宅地造成工事許可番号 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">宅地造成工事許可番号</Label>
              <Input placeholder="宅地造成工事許可番号" {...register("residentialPermitNumber")} />
            </div>

            {/* 地役権 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">地役権</Label>
              <Textarea placeholder="地役権" className="min-h-[40px]" {...register("easement")} />
            </div>

            {/* 国土法届出 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">国土法届出</Label>
              <Textarea
                placeholder="国土法"
                className="min-h-[40px]"
            ...
            {/* 敷地権 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">敷地権</Label>
              <Textarea
                placeholder="敷地権の詳細"
                className="min-h-[40px]"
                {...register("siteRights")}
            ...
            {/* 状態・状況 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">状態・状況</Label>
              <Controller
                name="propertyStatus"
                control={control}
                render={({ field }) => (
            ...
            {/* 地番 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">地番</Label>
