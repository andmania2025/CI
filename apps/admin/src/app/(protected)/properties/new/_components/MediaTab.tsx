          ...
          <div className="grid grid-cols-2 gap-4 h-full">
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <Label className="text-sm font-medium mb-2 block">物件カテゴリ</Label>
                  <Controller
                ...
                <div className="space-y-1">
                  <Label className="text-sm font-medium mb-2 block">問い合わせ回数</Label>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <Label className="text-sm font-medium mb-2 block">注目設定</Label>
                  <Controller
                    name="featured"
                    control={control}
                    render={({ field }) => (
                ...
                <div className="space-y-1">
                  <Label className="text-sm font-medium mb-2 block">公開範囲</Label>
                  <Controller
                    name="publicScope"
                    control={control}
                    render={({ field }) => (
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <Label className="text-sm font-medium mb-2 block">取引条件有効期限</Label>
                  <Controller
                    name="validUntilDate"
                    control={control}
                    render={({ field }) => (
              ...
              {/* 掲載媒体選択 */}
              <div className="space-y-1">
                <Label className="text-sm font-medium">掲載媒体選択</Label>
                <Controller
              ...
              {/* 注目期間 */}
              <div className="space-y-1">
                <Label className="text-sm font-medium">注目期間</Label>
              ...
              {/* 公開範囲予約 */}
              <div className="space-y-1">
                <Label className="text-sm font-medium">公開範囲予約</Label>
                <Controller
              ...
              {/* 公開予約日 */}
              <div className="space-y-1">
                <Label className="text-sm font-medium">公開予約日</Label>
                <Controller
