      ...
      <Card className="flex-1 flex flex-col overflow-hidden">
        <CardContent className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-4 gap-4">
            ...
            {/* 土地面積（㎡） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">土地面積（㎡）</Label>
            ...
            {/* 建築確認番号 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">建築確認番号</Label>
              <Input placeholder="確認番号" {...register("buildingConfirmationNumber")} />
            </div>

            {/* 建物構造 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">建物構造</Label>
              <Controller
            ...
            {/* 施工実者 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">施工実者</Label>
            ...
            {/* 筆戸数・筆区画数 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">筆戸数・筆区画数</Label>
              <Input placeholder="筆戸数" type="number" {...register("totalUnits")} />
            </div>

            {/* 販売戸数・販売区画数 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">販売戸数・販売区画数</Label>
              <Input placeholder="販売戸数" type="number" {...register("salesUnits")} />
            </div>

            {/* 所在階・階数 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">所在階・階数</Label>
            ...
            {/* バルコニー面積（㎡） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">バルコニー面積（㎡）</Label>
              <Input placeholder="バルコニー" type="number" {...register("balconyArea")} />
            </div>

            {/* 間取り詳細 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">間取り詳細</Label>
            ...
            {/* 開取り詳細 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">開取り詳細</Label>
              <Textarea
            ...
            {/* 主要採光面 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">主要採光面</Label>
              <Controller
                name="mainLighting"
                control={control}
                render={({ field }) => (
            ...
            {/* 坪単価（万円/坪） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">坪単価（万円/坪）</Label>
              <Input placeholder="坪単価" type="number" {...register("unitPrice")} />
            </div>

            {/* 印紙税（円） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">印紙税（円）</Label>
              <Input placeholder="印紙税" type="number" {...register("stampTax")} />
            </div>

            {/* 想定賃料（万円） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">想定賃料（万円）</Label>
              <Input placeholder="想定賃料" type="number" {...register("expectedRent")} />
            </div>

            {/* 利用金（円） */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2 block">利用金（円）</Label>
