        ...
        <CardContent className="flex-1 overflow-y-auto p-6">
          <div className="grid grid-cols-2 grid-rows-3 gap-4 h-full">
            ...
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2">環境・周辺施設</Label>
              <Textarea
            ...
            {/* 諸費用等 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2">諸費用等</Label>
              <Textarea
            ...
            {/* 駐車場・駐輪場等 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2">駐車場・駐輪場等</Label>
              <Textarea
            ...
            {/* その他費用等 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2">その他費用等</Label>
              <Textarea
            ...
            {/* 法令上制限 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2">法令上制限</Label>
              <Textarea
            ...
            {/* その他建築事項等 */}
            <div className="space-y-1">
              <Label className="text-sm font-medium mb-2">その他建築事項等</Label>
              <Textarea
