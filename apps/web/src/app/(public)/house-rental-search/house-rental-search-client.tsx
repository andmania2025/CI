...
export function HouseRentalSearchClient() {
    ...
    <>
      ...
      <main className="pt-4 pb-8">
        <div className="max-w-7xl mx-auto px-4">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900 mb-2">一戸建て賃貸物件検索</h1>
            <p className="text-gray-600">一戸建てに関する賃貸物件の検索・条件指定が行えます。</p>
          </div>
