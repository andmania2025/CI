 ...
 */
export const ProductCardContent = React.memo<ProductCardContentProps>(({ product }) => {
  return (
    <div className="p-3 h-[40%]">
      <div className="space-y-3">
        ...
        <div className="space-y-1">
          <h2 className="line-clamp-1 font-semibold text-gray-900 text-base">{product.title}</h2>
          {/* 住所 */}
          {product.address && (
